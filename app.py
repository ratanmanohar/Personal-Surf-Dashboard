...
# Page configuration
st.set_page_config(
    page_title="Ratan's Surf Dashboard",
    page_icon="🏄‍♂️",
    layout="wide",
...
class EnhancedSurfDashboard:
    ...
    def calculate_surf_score(self, combined_data, user_prefs, spot_info):
        """Calculate surf score with proper bounds (0-100)"""
    ...
    def create_dashboard(self):
        ...
        st.markdown('<h1 class="main-header">🏄‍♂️ Ratan\'s Surf Dashboard</h1>', unsafe_allow_html=True)
        st.markdown("**Real-time surf forecasts with intelligent recommendations and interactive visualizations**")
        ...
        if 'surf_data' in st.session_state:
            ...
            with tab1:
                st.subheader("Interactive Surf Conditions Map")
            ...
            with tab2:
                st.subheader("Surf Recommendations")
                ...
                with col1:
                    for i, rec in enumerate(recommendations[:5]):
                        # Color-coded recommendation items
                        if rec['score'] >= 100:
                            score_color = "#00ff00"
                            score_circle = "🟢"
                        elif rec['score'] >= 80:
                        ...
                        with st.container():
                            # Sleeker recommendation display
                            st.markdown(f"""
                            <div class="recommendation-item">
                                <div class="recommendation-header">
                                    <span class="score-circle" style="background-color: {score_color};"></span>
                                    #{i+1}: {rec['spot']}
                                </div>
                                <div class="recommendation-details">
                                    <strong>Total Score:</strong> {rec['score']:.0f}/135 (Surf: {rec['surf_score']:.0f}/100 + Bonus: {rec['bonus_points']}/35)
                                </div>
                            </div>
                            """, unsafe_allow_html=True)
            ...
            with tab5:
                ...
                <p><strong>Marine Conditions:</strong> Open-Meteo Marine API</p>
                <ul>
                <li>Wave height, direction, and period data</li>
                <li>Swell height and direction</li>
                <li>Updated every 6 hours</li>
                </ul>
                
                <p><strong>Weather Data:</strong> Open-Meteo Weather API</p>
                <ul>
                <li>Wind speed, direction, and gusts</li>
                <li>Air temperature and visibility</li>
                <li>Updated hourly</li>
                </ul>
                
                <p><strong>Tide Information:</strong> NOAA CO-OPS API</p>
                <ul>
                <li>Tide predictions and current levels</li>
                <li>Station-specific measurements</li>
                <li>Updated every 6 minutes</li>
                </ul>
                </div>
                """, unsafe_allow_html=True)
                ...
                <h4>Scoring & Matching Algorithm</h4>
                
                <p>The surf scoring system evaluates conditions on a 0-100 scale based on four key factors:</p>
                
                <p><strong>Wave Height Scoring (40 points maximum):</strong><br>
                Optimal wave heights vary by skill level:
                <ul>
                <li><strong>Beginner (Low):</strong> 1-3ft waves score highest</li>
                <li><strong>Intermediate (Medium):</strong> 2-6ft waves score highest</li>
                <li><strong>Advanced (High):</strong> 4-12ft waves score highest</li>
                </ul>
                </p>
                
                <p><strong>Wind Conditions (25 points maximum):</strong><br>
                <ul>
                <li>Light winds (0-8 mph): 25 points</li>
                <li>Moderate winds (8-12 mph): 20 points</li>
                <li>Strong winds (12-18 mph): 10 points</li>
                <li>Very strong winds (18+ mph): 0 points</li>
                </ul>
                </p>
                
                <p><strong>Wave Period (20 points maximum):</strong><br>
                Longer periods indicate more organized, powerful waves:
                <ul>
                <li>12+ second period: 20 points</li>
                <li>8-12 second period: 15 points</li>
                <li>6-8 second period: 10 points</li>
                <li>Below 6 seconds: 5 points</li>
                </ul>
                </p>
                
                <p><strong>Spot Characteristics (15 points maximum):</strong><br>
                Bonus points for matching your preferences:
                <ul>
                <li>Skill level match: 8 points</li>
                <li>Board type compatibility: 7 points</li>
                </ul>
                </p>
                
                <p><strong>Additional Preference Bonuses (up to 35 points):</strong><br>
                <ul>
                <li>Break type match: +10 points</li>
                <li>Board type match: +10 points</li>
                <li>Skill level match: +15 points</li>
                </ul>
                </p>
                
                <p>The final recommendation score combines the base surf score (0-100) with preference bonuses (0-35) for a maximum total of 135 points.</p>
                </div>
                """, unsafe_allow_html=True)
            ...
            **Note:** Surf scores are calculated based on wave height, wind conditions, wave period, and spot characteristics relative to your preferences.
            """)
